    ...
    public partial class FrmMain : Form
    {
        ...
        private void BtnCheck_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // int -> 4byte정수, decimal -> 16bytes 실수
                // 큰 사이즈의 데이터형에 작은 사이즈 데이터형값을 할당(묵시적형변환)
                person.Age = Convert.ToInt32(NudAge.Value); // 이 방식 더 선호
            ...
            //    MessageBox.Show("수는 0으로 나눌수 없습니다", "예외", MessageBoxButtons.OK, MessageBoxIcon.Error);
            //    return;
            //}
