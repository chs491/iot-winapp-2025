...
namespace WinControlsApp
{
    public partial class FrmMain : Form
    {
        ...
        private void ChangeFont()
        {
            ...
            if (ChkItalic.Checked) style |= FontStyle.Italic; // 0000 | 0010 => 0010
        ...
        private void BtnNode_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("노드를 선택하시오", "경고", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        ...
        private void TreeToList(TreeNode node)
        {
            ...
            item.ImageIndex = 0; // 아이템의 이미지인덱스 지정
        ...
        private void BtnOpenImage_Click(object sender, EventArgs e)
        {
            ...
            if (DlgOpenImage.ShowDialog() == DialogResult.OK)
            {
                ...
                // PictureBoxSizeMode.StretchImage 이미지가 넓이, 높이를 픽쳐박스 크기에 맞춰서 이미지가 일그러짐
            }
